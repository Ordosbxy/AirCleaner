...
import com.saiyi.aircleaner.other.twocode.view.ViewfinderResultPointCallback;
  ...
  public void handleMessage(Message message) {
    switch (message.what) {
      ...
      case R.id.decode_succeeded:
        ...
        ((TwoCodeBusiness)activity.getBusiness()).handleDecode((Result) message.obj, barcode);//���ؽ��?        /***********************************************************************/
        break;
